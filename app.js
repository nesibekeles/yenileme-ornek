...
var DEMO_SIM_CSS =
  ...
  ".filters .head button:not(.demo-reset){display:none!important}" +
  ".filters .head .demo-reset{margin-left:auto;background:var(--pink,#E21B71)!important;border-color:var(--pink,#E21B71)!important;color:#fff!important}" +
...
function demoUpsell() {
  ...
  sec.innerHTML = head +
    ...
    '<iframe id="demo-sim" src="simulator/yeni_satis_simulatoru.html?v=demo6" title="Paketler yan yana" ' +
  ...
  f.addEventListener("load", function () {
    ...
    reset();
    /* the button sits in the simulator's own settings header, next to the
       "Paket karşılaştırma" pill, where the rep's eye already is */
    var head = doc.querySelector(".filters .head");
    if (head) {
      var rb = doc.createElement("button");
      rb.type = "button";
      rb.className = "demo-reset";
      rb.textContent = "↺ Firma Metriklerine Dön";
    ...
    $("#demo-sim-note").textContent = "Seçili gelen ayarlar: " +
      ...
      " dönüş oranı — hepsi mekanın kendi verisinden. Senaryoları deneyin; \"Firma Metriklerine Dön\" mekanın kendi ayarlarına geri getirir.";
